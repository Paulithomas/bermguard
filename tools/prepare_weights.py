...
hay que forzar la inicializacion del vocabulario durante el build. El encoder
queda cacheado en weights/clip/, ruta relativa que Ultralytics resuelve en
runtime sin necesidad de red.
"""
